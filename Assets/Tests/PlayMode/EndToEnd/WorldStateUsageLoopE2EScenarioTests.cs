...
{
    public sealed class WorldStateUsageLoopE2EScenarioTests : InputTestFixture
    {
        ...
        public IEnumerator SetUp()
        {
            ...
            _saveRoot = Path.Combine(Application.temporaryCachePath, "rootborn-world-usage-e2e", System.Guid.NewGuid().ToString("N"));
        ...
        [UnityTest]
        public IEnumerator WORLD_USAGE_E2E_001_010_SaveSlotKeyboardUsageLoopDisplaysPersistsAndDedupes()
        {
        ...
        private static IEnumerator StartNewTownFromSaveSlotUi()
        {
            ...
            yield return WaitForScene("Town", 15f, "WORLD-USAGE-E2E-001 failed: save slot UI did not enter Town.");
            yield return WaitForTownRuntime(15f);
        }
