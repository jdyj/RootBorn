...
namespace Rootborn.Game.Save
{
    public sealed class SaveService
    {
        ...
        public SaveSlotMetadata CreateMetadata(string slotId, Rootborn.Game.Player.CharacterCustomization character, int worldSeed, int tileSeed)
        {
            ...
            return new SaveSlotMetadata
            {
                ...
                WorldSeed = worldSeed,
                TileSeed = tileSeed,
                Character = character ?? new Rootborn.Game.Player.CharacterCustomization(),
            };
        }
        ...
        public SaveSlotMetadata LoadMetadata(string slotId)
        {
            ...
            try
            {
                ...
                {
                    metadata.Character = new Rootborn.Game.Player.CharacterCustomization();
                }
