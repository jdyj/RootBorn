...
namespace Rootborn.Game.Generation
{
    ...
    public sealed class GenerationProfile : ScriptableObject
    {
        ...
        [SerializeField] private float _lifetimeGameDays = 14f;
        ...
        public float LifetimeSec => Mathf.Max(0.001f, _lifetimeSec);
        public float LifetimeGameDays => Mathf.Max(0.001f, _lifetimeGameDays);
