    ...
    public sealed class DiscoveryPointInteractor : MonoBehaviour, IPlayerInteractable, IPrioritizedPlayerInteractable
    {
        ...
        public bool Interact(StudentLifeProgressComponent progressComponent)
        {
            ...
            if (applied)
            {
                ...
                var encyclopedia = progressComponent != null ? progressComponent.GetComponent<EncyclopediaProgressComponent>() : null;
                encyclopedia?.EvaluateUnlocks();
            }
            return applied;
        }
        ...
        {
            if (string.IsNullOrEmpty(key)) return "Discovery";
