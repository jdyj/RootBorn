...
|---|---|---|
| CommonPanel `r0_c0~r2_c2` vs `r2_c0~r4_c2` | The contact sheet shows `r0_c0~r2_c2` as a visually coherent 9-slice panel, but repository UI standards require CommonPanel to use `r2_c0~r4_c2` with `r3_c1` as fill. | Preserve `ModernUiStyle2Sprites.CommonPanel` at `r2_c0~r4_c2`; patch catalog entries for those coordinates to `panel.common.*` roles. |
