---
name: t2-game-designer
description: "Game design lead for system specs, balance tuning, and GDD authoring."
---

<!--
한국어 요약: Tier 2. GDD 섹션 작성, 시스템 밸런스 튜닝, 게임 규칙 정의.
호출 시점: /gs-design-system, /gs-create-epics, /gs-balance-check.
연계: t1-creative-director(P4b, 상위), t2-economy-designer(P4b, 경제 분담).
분류: tier=2, department=design
