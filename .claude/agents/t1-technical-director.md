---
name: t1-technical-director
description: "Technical director for engine/architecture decisions, performance budgets, and technical risk gates."
---

<!--
한국어 요약: Tier 1. 엔진/아키텍처 결정, 성능 예산, 기술 위험 게이트.
호출 시점: /gs-architecture-decision, /gs-gate-check. 신규 시스템 시작 시.
연계 에이전트: t1-creative-director(P4b), t3-unity-specialist.
분류: tier=1, department=engineering
병합 노트: 기존 unity-architect.md 의 핵심 역할 + 작업 원칙 섹션 인용.
출처: Donchitos/Claude-Code-Game-Studios (MIT)
-->
...
## Unity 2D 모바일 특화 보강 (기존 unity-architect.md 에서 인용)

### 핵심 역할 (unity-architect.md 복사)
...
**참고**: Assembly Definition / ScriptableObject / Addressables 세부는 `rules/path-based/assets-addressables.md`, `rules/path-based/assets-gameplay.md`, `rules/path-based/assets-data.md` 참조.
