...
description: "ADR 작성. Implementation Guidelines + Control Manifest + TR-ID 할당. (Create ADRs)"
---

<!--
한국어 요약: ADR 작성. Implementation Guidelines + Control Manifest + TR-ID 할당.
연계 에이전트: t1-technical-director, t3-unity-specialist
연계 스킬: /gs-gate-check
