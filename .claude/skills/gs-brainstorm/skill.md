---
name: gs-brainstorm
description: "게임 콘셉트 브레인스토밍. MDA/Core Loop/Pillars 로 게임 기둥·판타지 정의. (Game concept ideation)"
---

<!--
한국어 요약: 게임 콘셉트 브레인스토밍. MDA/Core Loop/Pillars 로 게임 기둥·판타지 정의.
연계 에이전트: t1-creative-director(P4b, fallback: t1-technical-director), t1-technical-director
