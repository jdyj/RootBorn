---
name: gs-changelog
description: "CHANGELOG.md 갱신. Added/Changed/Fixed/Removed 섹션. (Update CHANGELOG)"
---

<!--
한국어 요약: CHANGELOG.md 갱신. Added/Changed/Fixed/Removed 섹션.
연계 에이전트: t2-release-manager
연계 스킬: /gs-patch-notes
