---
name: gs-code-review
description: "게임/웹 코드 리뷰. 헌법·rules 준수 + 게임 특화. 기존 game-code-review 내부 호출. (Game code review, wraps game-code-review)"
---

<!--
한국어 요약: 게임/웹 코드 리뷰. 헌법·rules 준수 + 게임 특화. 기존 game-code-review 내부 호출.
연계 에이전트: code-reviewer
연계 스킬: game-code-review (internal)
