...
description: "Epic을 Type(Logic/Integration/Visual-Feel/UI/Config-Data) 태그 스토리로 분해. QL-STORY-READY gate. (Decompose epics into typed stories)"
---

<!--
한국어 요약: Epic을 Type(Logic/Integration/Visual-Feel/UI/Config-Data) 태그 스토리로 분해. QL-STORY-READY gate.
연계 에이전트: t2-qa-lead
연계 스킬: /gs-dev-story
