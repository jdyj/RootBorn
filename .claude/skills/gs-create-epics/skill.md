...
description: "GDD를 Epic으로 분해. production/epics/ 에 저장. (Break GDDs into epics)"
---

<!--
한국어 요약: GDD를 Epic으로 분해. production/epics/ 에 저장.
연계 에이전트: t1-producer(P4b, fallback: t2-game-designer)
연계 스킬: /gs-create-stories
