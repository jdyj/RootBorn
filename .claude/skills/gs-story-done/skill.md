---
name: gs-story-done
description: "스토리 완료 처리. 세션 상태 + Epic 진행률 갱신. (Close a story)"
---

<!--
한국어 요약: 스토리 완료 처리. 세션 상태 + Epic 진행률 갱신.
연계 에이전트: 
연계 스킬: /gs-release-checklist
...
- **No hardcoded strings check**: `Grep` for player-facing strings in `Assets/`
