...
description: "여러 GDD/ADR 간 수치·용어 충돌 검출. Entity Registry 기반. (Cross-artifact consistency)"
---

<!--
한국어 요약: 여러 GDD/ADR 간 수치·용어 충돌 검출. Entity Registry 기반.
연계 에이전트: qa-inspector (기존)
연계 스킬: /gs-gate-check
