...
description: "전투/경제 밸런스 검증. 플러그인 combat-balance-simulator 위임, 없으면 일반 분석. (Balance simulation, plugin delegation)"
---

<!--
한국어 요약: 전투/경제 밸런스 검증. 플러그인 combat-balance-simulator 위임, 없으면 일반 분석.
연계 에이전트: t2-economy-designer(P4b, fallback: t2-game-designer), 플러그인: combat-balance-simulator/currency-economist/growth-economist
연계 스킬: /gs-design-system
